        ...
        <ul className='pt-8'>
          <li className='flex items-center justify-between'>
            ...
            <AnchorButton
              ...
              variant="secondary"
              wide
                className='h-[44px] bg-[var(--color-white)] text-[var(--color-warning)] border-[var(--color-warning)] hover:bg-[var(--color-warning-bg-hover)] hover:border-[var(--color-warning)]'
            >
              削除
            </AnchorButton>
            {/* todo 後で確認画面遷移ボタン実装 */}
            <AnchorButton
              ...
              variant="secondary"
              wide
              className='h-[44px] bg-[var(--color-white)] text-[var(--color-primary)] border-[var(--color-primary)] hover:bg-[var(--color-primary-bg-hover)] hover:border-[var(--color-primary)]'
            >
              編集
            </AnchorButton>
            {/* <Button
